...
namespace eval ::selenium {
    ...
    oo::class create WebDriver {
        ...
        variable driver remote_connection error_handler \
            current_capabilities session_ID w3c_compliant \
            Command Mouse_Button Exception StatusCache By \
            JAVASCRIPT_RETURNS_ELEMENT JAVASCRIPT_RETURNS_ELEMENTS WEB_ELEMENT_ID

        mixin ::selenium::Mixin_For_Element_Retrieval \
                ::selenium::Mixin_For_Scrolling \
                ::selenium::Mixin_For_Mouse_Interaction \
                ::selenium::Mixin_Action_Chains
        ...
        constructor {service_url desired_capabilities {required_capabilities {}}} {
            ...
            namespace eval [self] {
                namespace upvar ::selenium \
                        Command Command \
                        Exception Exception \
                        Mouse_Button Mouse_Button \
                        StatusCache StatusCache \
                        By By \
                        JAVASCRIPT_RETURNS_ELEMENT JAVASCRIPT_RETURNS_ELEMENT \
        ...
        method start_session {desired_capabilities required_capabilities} {
            ...
            if {[dict exists $json_response sessionId]} {
            ...
            } elseif {[dict exists $json_response value]} {
                # geckodriver
                ...
                error "Unknown response: $json_response"
            }

            # Quick check to see if we have a W3C Compliant browser.
            # According to SauceLabs "If that line begins with 'desiredCapabilities', you are running the non-W3C version.
            # If it begins with 'capabilities', you are running the new W3C-compliant version."
...
#           log debug {$remote_connection dispatch $session_ID $command_name $args}
        ...
        method select_element {element_ID command_var} {
           ...
           trace add variable select_element unset [list $select_element destroy]
        }
        ...
        method add_cookie {args} {
            ...
            foreach {parameter_name value} $args {
