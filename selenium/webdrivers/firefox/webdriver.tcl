...
namespace eval ::selenium::webdrivers::firefox {
    ...
    oo::class create FirefoxDriver {
        ...
        constructor {args} {
            ...
            if {[info exists path_to_browser_binary]} {
                ...
                if {$path_to_browser_binary eq ""} {
                    ...
                    throw $::selenium::Exception(WebdriverException) "Could not find firefox in your system. Please specify the firefox binary location or install firefox"
                }
            }
        ...
        method stop_client {} {
            ...
            # FIXME: for gecko only?
            if {1 || $use_geckodriver} {
                if {[info exists log_filehandler]} {
        ...
        method _start_client_with_geckodriver {} {
            ...
            # gecko 0.27.0 does not support this option
            #if {[info exists path_to_log_file]} {
            #    lappend parameters --log-file=\"$path_to_log_file\"
            #}
            #lappend parameters -vv
...
#puts stderr [list _firefox_env [array get _firefox_env]]
#puts stderr [list _firefox_exe exec $path_to_browser_binary -foreground > $path_to_log_file]
